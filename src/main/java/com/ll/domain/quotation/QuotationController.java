...
public class QuotationController {
    ...
    private List<com.ll.domain.quotation.Quotation> quotations;
    ...
    public void actionWrite() {
        ...
        com.ll.domain.quotation.Quotation quotation = write(content, authorName);
    ...
    public void actionList() {
        ...
        for (int i = quotations.size() - 1; i >= 0; i--) {
            com.ll.domain.quotation.Quotation quotation = quotations.get(i);
    ...
    public void actionModify(Rq rq) {
        ...
        com.ll.domain.quotation.Quotation quotation = quotations.get(index);
    ...
    private com.ll.domain.quotation.Quotation write(String content, String authorName) {
        lastQuotationId++;
        int id = lastQuotationId;

        com.ll.domain.quotation.Quotation quotation = new com.ll.domain.quotation.Quotation(id, content, authorName);
